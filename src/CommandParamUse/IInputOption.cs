...
namespace CommandParamUse
{
    ...
    public interface IInputOption<TParam> : IInputOption where TParam : IParameters
    {
        /// <summary>
        /// 是否全局
        /// </summary>
    ...
    public struct InputOption<TOptionValue, TParam> : IInputOption<TParam> where TParam : IParameters
    {
        ...
        public InputOption(Option<TOptionValue> option, Action<TParam, TOptionValue> fillParamMethod, bool isGlobal = false)
        {
            this.option = option;
